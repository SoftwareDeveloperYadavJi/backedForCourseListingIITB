...
public class CourseInstanceController {
    ...
    @Operation(summary = "Get course instances by year and semester", description = "Returns all course instances for a specific year and semester")
    ...
    public ResponseEntity<List<CourseInstanceResponseDto>> getInstancesByYearAndSemester(
        ...
        List<CourseInstanceResponseDto> instances = courseInstanceService.getInstancesByYearAndSemester(year, semester);
        return ResponseEntity.ok(instances);
    }

    @GetMapping("/{year}/{semester}/{courseId}")
    @Operation(summary = "Get specific course instance", description = "Returns details of a specific course instance")
    ...
    public ResponseEntity<CourseInstanceResponseDto> getInstanceByYearSemesterAndCourseId(
        ...
        CourseInstanceResponseDto instance = courseInstanceService.getInstanceByYearSemesterAndCourseId(year, semester,
                courseId);
    ...
    @Operation(summary = "Delete a course instance", description = "Deletes a specific course instance")
