...
public class CourseService {
    ...
    public CourseResponseDto createCourse(CourseRequestDto courseRequestDto) {
        ...
        if (courseRequestDto.getPrerequisiteCourseIds() != null && !courseRequestDto.getPrerequisiteCourseIds().isEmpty()) {
    ...
    public void deleteCourse(String courseId) {
        ...
        if (courseRepository.isPrerequisiteForAnyCourse(course.getId())) {
            throw new DependencyExistsException("Cannot delete course " + courseId + " as it is a prerequisite for other courses");
        }
