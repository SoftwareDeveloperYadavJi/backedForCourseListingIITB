...
public class CourseControllerTest {
    ...
    public void getAllCourses_ShouldReturnCourses() throws Exception {
        // Arrange
        CourseResponseDto course1 = new CourseResponseDto(1L, "CS101", "Introduction to Programming", "Description", Collections.emptyList());
        CourseResponseDto course2 = new CourseResponseDto(2L, "CS102", "Advanced Programming", "Description", Collections.emptyList());
    ...
    public void createCourse_ShouldCreateCourse() throws Exception {
        // Arrange
        CourseResponseDto createdCourse = new CourseResponseDto(1L, "CS101", "Introduction to Programming", "Description", Collections.emptyList());
        ...
        mockMvc.perform(post("/api/courses")
                ...
                .content("{\"courseId\":\"CS101\",\"title\":\"Introduction to Programming\",\"description\":\"Description\"}"))
    ...
    public void getCourseById_ShouldReturnCourse() throws Exception {
        // Arrange
        CourseResponseDto course = new CourseResponseDto(1L, "CS101", "Introduction to Programming", "Description", Collections.emptyList());
